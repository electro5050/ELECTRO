        ...
        <div className='terms-main'>
            ...
            <div className='term-header'>
                ...
                <div className='term-links'>
                    <a href="/" className="term-link">Terms and Conditions</a>
                ...
                <div className='terms-condition'>
                    <div className='terms-text'>
                       <p className='terms-contents'>Welcome to Electro5050! By accessing and using our online bidding game, you agree to comply with the following terms and conditions:<br></br><br></br><br></br>
