...
const PurchaseCoin = ({handleButtonClick, selectedButton})  => {
  ...
  return (
    ...
    <div className='d-flex' style={{marginTop:"5vh", alignItems:"flex-start"}}>
      <div style={{flex:"1"}}>
       <div>
...
<hr className="custom-horizontal-line" />
                <span className='wallet-value font-6 ml-10 d-flex v-cen'>
                  ...
                  <input type="number" placeholder=""  style={{ border: 'none', outline: 'none', padding:0,appearance: 'textfield'  }} className="font-6 ml-10 wallet-amount-input" />
        ...
        <Button
        variant={`outline-primary checkout-btn font-4 mt-10 ${selectedButton === 'buy' ? 'selected' : ''}`}
        onClick={() => handleButtonClick('purchase-trasaction')}
      >
        CHECKOUT
      </Button>
