...
<div className="container" style={{ backgroundSize: '100% 100%',backgroundposition:'center', backgroundRepeat: 'no-repeat', borderRadius: "1.2vw", height: "60vh",width:"100%", overflowY: "auto", 
      fontWeight:"700", color: "white", padding:"2vw"}}>
          ...
          <div className='tutorial-mainparentmobile'>
            <div className='tutorial-parent'>
              <div className='tutorial-inner'>
                <div className='innertutorail-chaildmobile'>
                  <div className='innertutorial-chaild01mobile'>
                  STEP 1
                  </div>

                </div>

                <div className='innertutorail-chaild01mobile'>
                  <div className='innertutorial-chaild02mobile'>
                  Buy Coins
                  </div>

                </div>

                <div className='innertutorail-chaild02mobile'>
                  <div className='innertutorial-chaild03mobile'>
