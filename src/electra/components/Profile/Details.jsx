...
AWS.config.update({
  accessKeyId: 'AKIAQCSOIX6QNEDCKSWW',
  secretAccessKey: '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',
  region: 'eu-north-1',
});
const s3 = new AWS.S3();
  ...
  if (file && file.type.startsWith('image/')) {
    ...
    s3.upload(params, function (err, data) {
      ...
      if (err) {
        ...
        // Here you can update your state or UI with the location of the file
      }
    });
  } else {
