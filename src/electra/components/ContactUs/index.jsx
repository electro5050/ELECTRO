  ...
  return (
    <div className="membership-game">
      ...
      fontWeight:"700", color: "white", padding:"1.2em"}}>
          ...
          <div style={{width:"100%", textAlign:"center", fontSize:"1.5em"}}>
          contact us
          </div>

          <div style={{width:"100%", textAlign:"left", fontSize:"1em", marginTop:"1vh", fontWeight:"300"}}>
          ...
          <div style={{width:"100%", textAlign:"left", fontSize:"1.2em", marginTop:"2vh", fontWeight:"700"}}>
          Player Support:
          </div>

          <div style={{width:"100%", textAlign:"left", fontSize:"1em", marginTop:"0.3vh", fontWeight:"300"}}>
          ...
          <div style={{width:"100%", textAlign:"left", fontSize:"1em", marginTop:"0.3vh",marginBottom:"2vh", fontWeight:"300"}}>
          For instant assistance, click on our Live Chat button available at the bottom right of our site.
          </div>

          <div style={{width:"100%", textAlign:"left", fontSize:"1.2em", fontWeight:"700", display: "inline"}}>
          Please note:

            <span style={{width:"100%", textAlign:"left", fontSize:"1em", marginLeft:"10px", fontWeight:"300"}}>
