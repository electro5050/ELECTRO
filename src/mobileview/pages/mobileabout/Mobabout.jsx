...
function Mobabout() {
  ...
  return (
    <div className='mobabout-main-container'>
    <div className='mobterms-main'>
        ...
        <h1 className='mobabout'>ABOUT US</h1>
            <div className='mobabout-condition'>
                <div className='mobabout-text'>
                    
                <p className='mobabout-contents'>
                    <h2 className='mobabout-us'>       Welcome to Electro 50-50, the world's first and most innovative bidding platform     </h2>
                   ...
                   <p className='mobabout-heading'>Mission:<br></br><br></br></p> 
                    ...
                    <p className='mobabout-heading'>Key Features:<br></br><br></br></p>
                      ...
                      <p className='mobabout-heading'>The Ultimate Online Bidding Experience:
                      '<br></br><br></br></p>
                      ...
                      <p className='mobabout-heading'>Tagline:<br></br><br></br></p>
